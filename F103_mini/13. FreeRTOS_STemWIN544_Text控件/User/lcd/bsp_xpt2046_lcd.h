...
/******************************* XPT2046 触摸屏中断引脚定义 ***************************/
#define             macXPT2046_INT_GPIO_CLK                        RCC_APB2Periph_GPIOC   
#define             macXPT2046_INT_GPIO_PORT                       GPIOC
#define             macXPT2046_INT_GPIO_PIN                        GPIO_Pin_12
...
#define             macXPT2046_SPI_GPIO_CLK                         RCC_APB2Periph_GPIOC

#define             macXPT2046_SPI_CS_PIN		                        GPIO_Pin_9
#define             macXPT2046_SPI_CS_PORT		                      GPIOC

#define	            macXPT2046_SPI_CLK_PIN	                        GPIO_Pin_8
#define             macXPT2046_SPI_CLK_PORT	                        GPIOC

#define	            macXPT2046_SPI_MOSI_PIN	                        GPIO_Pin_10
#define	            macXPT2046_SPI_MOSI_PORT	                      GPIOC

#define	            macXPT2046_SPI_MISO_PIN	                        GPIO_Pin_11
#define	            macXPT2046_SPI_MISO_PORT	                      GPIOC
