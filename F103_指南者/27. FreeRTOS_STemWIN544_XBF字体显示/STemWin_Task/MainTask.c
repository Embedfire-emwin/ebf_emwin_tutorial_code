...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  ...
  { TEXT_CreateIndirect, "Text", ID_TEXT_1, 0, 55, 230, 108, 0, 0x64, 0 },
  { MULTIEDIT_CreateIndirect, "Multiedit", ID_MULTIEDIT_0, 5, 60, 230, 130, 0, 0x0, 0 },
//  { BUTTON_CreateIndirect, "Button", ID_BUTTON_0, 5, 200, 100, 36, 0, 0x0, 0 },
//  { BUTTON_CreateIndirect, "Button", ID_BUTTON_1, 125, 200, 100, 36, 0, 0x0, 0 },
};
  ...
  switch (pMsg->MsgId)
	{
		case WM_INIT_DIALOG:
			...
			FRAMEWIN_SetFont(hItem, &FONT_XINSONGTI_18);
			/* 初始化TEXT0 */
			...
			MULTIEDIT_SetFont(hItem, &FONT_XINSONGTI_18);
