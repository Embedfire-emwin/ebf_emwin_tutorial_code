...
static void _ShowDemo(void)
{
  ...
  hFrame1  = FRAMEWIN_CreateEx( 10, 30, 160, 160, 0, WM_CF_SHOW, FRAMEWIN_CF_MOVEABLE, 0, "Early Clipping", _cbFrameWin1);
  hFrame2  = FRAMEWIN_CreateEx(190, 30, 160, 160, 0, WM_CF_SHOW, FRAMEWIN_CF_MOVEABLE, 0, "Late Clipping", _cbFrameWin2);
...
//  _hWin2   = WM_CreateWindowAsChild(0, 0, WM_GetWindowSizeX(hClient2), WM_GetWindowSizeY(hClient2), hClient2, WM_CF_SHOW | WM_CF_LATE_CLIP, _cbFrameWin2, 0);
  _hBut1   = BUTTON_CreateEx( 10, 225, 160, 30, 0, WM_CF_SHOW, 0, 1);
  _hBut2   = BUTTON_CreateEx(190, 225, 160, 30, 0, WM_CF_SHOW, 0, 2);
