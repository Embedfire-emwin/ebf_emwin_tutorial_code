...
//
DEFINE_DMA2D_COLORCONVERSION(M888I,  LTDC_Pixelformat_ARGB8888) // Internal pixel format of emWin is 32 bit, because of that ARGB8888
...
void LCD_X_Config(void) {
  ...
  for (i = 0; i < GUI_NUM_LAYERS; i++) {
    ...
    GUICC_M8888I_SetCustColorConv(_Color2IndexBulk_M888I_DMA2D,   _Index2ColorBulk_M888I_DMA2D);   // Set up custom bulk color conversion using DMA2D for RGB888
    //
